...
export const workExperience = [
  {
    ...
    achievements: [
      "Recolección, auditoría y validación de datos desde diversas fuentes para garantizar su calidad.",
      "Desarrollo de análisis exploratorios, visualizaciones e indicadores (KPIs) usando Power BI.",
      "Integración de datos enviados por clientes a las bases de datos corporativas.",
      "Colaboración con analistas para generar informes estratégicos y proponer mejoras en la recolección de datos.",
...
export const education = [
  {
    ...
    degree: "Magíster en Ingeniería, Systems Engineering",
    period: "Enero 2026 - Enero 2028",
    achievements: [
      "Continuación de formación avanzada en ingeniería de sistemas.",
    ],
  },
  {
    institution: "Universidad Tecnológica de Bolívar (UTB)",
...
export const skills = {
  ...
  frontendDevelopment: ["React", "Astro", "Tailwind CSS", "HTML/CSS"],
  backendDevelopment: ["FastAPI", "Django", "Node.js", "ETL Pipelines", "LangChain", "LangGraph"],
  databaseAndStorage: ["PostgreSQL", "MongoDB", "Redis", "ChromaDB (Vectorial)"],
  cloudAndDevOps: ["Docker", "AWS", "Azure", "Git"],
  toolsAndServices: ["Google Gemini (GenAI)", "Power BI", "Pandas", "Scikit-learn", "TensorFlow", "Excel"],
};
...
export const projects = [
  ...
  },
  {
    ...
    description: [
      ...
      "Algoritmo de asignación automática con control de prioridad, consecutividad y balance de carga laboral.",
      "Generación de cronogramas detallados para la gestión eficiente del personal de cajas.",
    ],
  },
];
...
export const awards = [
  ...
  {
    name: "Ciberseguridad y Manejo Seguro de la Información",
    issuer: "UTB",
    date: "2023",
    type: "Certification",
    position: "Certified",
